...
export const SIGN_UP_FIELD_DEFAULT = {
  email: '',
  fullName: '',
  universityId: 0,
  password: '',
...
export const SIGN_IN_FIELD_DEFAULT = {
  email: '',
  password: '',
};
...
export const sampleBooks = [
  {
    ...
    colorHash: '#1c1f40',
    coverImageUrl: 'https://m.media-amazon.com/images/I/81J6APjwxlL.jpg',
  ...
  },
  {
    ...
    colorHash: '#fffdf6',
    coverImageUrl: 'https://m.media-amazon.com/images/I/81F90H7hnML.jpg',
    video: '/sample-video.mp4?updatedAt=1722593504152',
    summary:
      'A revolutionary guide to making good habits, breaking bad ones, and getting 1% better every day.',
  },
  ...
  },
  {
    ...
    colorHash: '#ffffff',
    coverImageUrl: 'https://m.media-amazon.com/images/I/81JJ7fyyKyS.jpg',
    video: '/sample-video.mp4?updatedAt=1722593504152',
    summary:
      'Rules for focused success in a distracted world, teaching how to cultivate deep focus to achieve peak productivity.',
  },
